...
async function loadCompanyCodeConfig() {
  const stored = await getDocument(COMPANY_CODES_COLLECTION, COMPANY_CODES_DOCUMENT);
...
async function authenticateCompanyCode(value) {
...
async function validateCompanySession(request) {
